...
- [ ] 1. Set up middleware and authorization infrastructure
  ...
  - [ ] 1.2 Write unit tests for EnsureOwnerAccess middleware
...
- [ ] 2. Extend MosqueRepository with owner dashboard methods
  ...
  - [ ] 2.2 Implement countByStatus method in MosqueRepository
  ...
  - [ ] 2.3 Implement getTotalCongregationCount method
  ...
  - [ ] 2.4 Implement getPending method with search support
  ...
  - [ ] 2.5 Implement findWithRelations method
  ...
  - [ ] 2.6 Write unit tests for repository methods
...
- [ ] 3. Create DashboardService for platform statistics
  - [ ] 3.1 Create DashboardService class
  ...
  - [ ] 3.2 Implement platform fee calculation
...
- [ ] 4. Create MosqueService for owner operations
  - [ ] 4.1 Create MosqueService class
  ...
  - [ ] 4.2 Implement getPendingMosques method
  ...
  - [ ] 4.3 Implement getMosqueDetail method
  ...
  - [ ] 4.4 Implement getDaysWaiting helper method
  ...
  - [ ] 4.5 Write unit tests for MosqueService
    - Mock MosqueRepositoryInterface in tests
...
- [ ] 5. Checkpoint - Verify backend services and repository
  - Ensure all service and repository methods compile without errors
  - Ensure all tests pass, ask the user if questions arise

- [ ] 6. Create Owner DashboardController
  - [ ] 6.1 Create DashboardController in Owner namespace
  ...
  - [ ] 6.2 Register dashboard route with middleware
    - Open `routes/web.php`
  ...
  - [ ] 6.3 Write feature test for dashboard access
...
- [ ] 7. Create Owner MosqueController
  - [ ] 7.1 Create MosqueController in Owner namespace
    - Create `app/Http/Controllers/Owner/MosqueController.php`
    - Extend base Controller class
    - Inject MosqueService via constructor with property promotion
    - _Requirements: 3.1, 4.1, 5.1_

  - [ ] 7.2 Implement index method for mosque list
  ...
  - [ ] 7.3 Implement pending method for pending mosque queue
  ...
  - [ ] 7.4 Implement show method for mosque detail
  ...
  - [ ] 7.6 Write feature tests for mosque controller
...
- [ ] 8. Create DTOs for mosque verification operations
  - [ ] 8.1 Create ApproveMosqueDTO
...
- [ ] 9. Checkpoint - Verify backend is complete
  - Ensure all controllers, services, and DTOs are implemented
  - Ensure all routes are registered and accessible
  - Ensure all tests pass, ask the user if questions arise

- [ ] 10. Create owner dashboard layout and partials
  - [ ] 10.1 Create base layout for owner panel
  ...
  - [ ] 10.2 Create sidebar navigation component
  ...
  - [ ] 10.3 Create top navbar component
...
- [ ] 11. Create dashboard statistics view
  - [ ] 11.1 Create dashboard blade template
  ...
  - [ ] 11.3 Create quick actions section
...
- [ ] 12. Create mosque list view with filtering
  - [ ] 12.1 Create mosque list blade template
  ...
  - [ ] 12.3 Create mosques data table
  ...
  - [ ] 12.4 Add DataTables JavaScript initialization
...
- [ ] 13. Create pending mosque queue view
  - [ ] 13.1 Create pending mosques blade template
  ...
  - [ ] 13.3 Create pending mosques table
...
- [ ] 14. Create mosque detail view
  - [ ] 14.1 Create mosque detail blade template
  ...
  - [ ] 14.2 Display mosque basic information section
  ...
  - [ ] 14.3 Display contact details section
  ...
  - [ ] 14.6 Display statistics section
  ...
  - [ ] 14.7 Display status-specific information
...
- [ ] 15. Add database indexing for performance
  - [ ] 15.1 Create migration for mosque status index
...
- [ ] 16. Implement loading states and empty states
  - [ ] 16.1 Add loading indicators to views
...
- [ ] 17. Final integration and testing
  - [ ] 17.1 Wire pending count to sidebar badge
  ...
  - [ ] 17.2 Ensure responsive layout compliance
